    ...
    <table class="table table-striped">
      ...
      @foreach ($movimentos as $movimento)
        <tr>
            ...
            <td>
                <a class="btn btn-primary" href="{{action('MovementController@edit',['id'=>$movimento->id])}}">Editar</a>
                <form action="{{action('MovementController@destroy', ['id'=>$movimento->id])}}" method="POST" role="form" class="inline">
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}

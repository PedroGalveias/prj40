...
@section('content')
    ...
    <form method="POST" action="{{action('MovementController@update',['id'=>$movimento->id])}}" encrypte="multipart/form-data">
        @method('PUT')
        {{csrf_field()}}
        <div class="form-group">
            <label for="aeronave" class="col-sm-4 col-form-label"> num licenca piloto </label>
            <div class="col-sm-10">
                <input type="text" name="num_licenca_piloto" class="form-control" id="num_licenca_piloto" placeholder="num_licenca_piloto"  value="{{old('num_licenca_piloto',$movimento->num_licenca_piloto)}}" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="observacoes" class="form-control" id="observacoes" placeholder="observacoes" value="{{old('observacoes',$movimento->observacoes)}}" />
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-success" name="ok" href="{{action('MovementController@update',['id'=>$movimento->id])}}" value="Guardar">

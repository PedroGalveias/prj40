    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{action('MovementController@index')}}">Lista</a>
                    <a class="dropdown-item" href="{{action('MovementController@create')}}">Adicionar</a>
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{action('UserController@profile')}}">Perfil</a>
                            <a class="dropdown-item" href="{{action('HomeController@index')}}">Home</a>
                            @can('direcao', auth()->user())
                            <a class="dropdown-item" href="{{action('AeronaveController@tablePriceHour')}}">Preço-hora aeronave</a>
                            @endcan
                            <a class="dropdown-item" href="{{action('UserController@showChangePasswordForm')}}  ">Alterar palavra-passe</a>

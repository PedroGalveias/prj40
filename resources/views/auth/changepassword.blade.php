            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{action('UserController@showChangePasswordForm')}}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="new-password-confirm" class="col-md-4 control-label">Confirme palavra-passe</label>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    ...
                                    <a class="btn btn-primary" href="{{action('HomeController@index')}}">voltar</a>
                                </div>
                            </div>
                        </form>
                    </div>

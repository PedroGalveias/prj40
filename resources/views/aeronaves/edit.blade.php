                ...
                <div class="card">
                    <form method="POST" action="{{ route('aeronaves.update', ['matricula'=>$aeronave->matricula]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="marca" class="form-control" id="marca" placeholder="Marca" value="{{old('marca', $aeronave->marca)}}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="marca" class="col-sm-4 col-form-label"> Matricula </label>
                            <div class="col-sm-10">
                                <input type="text" name="matricula" class="form-control" id="matricula" placeholder="Matricula" value="{{old('matricula', $aeronave->matricula)}}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="marca" class="col-sm-4 col-form-label"> Modelo </label>
                            <div class="col-sm-10">
                                <input type="text" name="modelo" class="form-control" id="modelo" placeholder="Modelo" value="{{old('modelo', $aeronave->modelo)}}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="marca" class="col-sm-4 col-form-label"> Num lugares </label>
                            <div class="col-sm-10">
                                <input type="text" name="num_lugares" class="form-control" id="num_lugares" placeholder="Num_lugares" value="{{old('num_lugares', $aeronave->num_lugares)}}" />
                            </div>
                        </div>
                        <div class="form-group">

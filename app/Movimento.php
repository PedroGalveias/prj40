...
class Movimento extends Model
{
    ...
    protected $fillable = [
        ...
        'validade_licenca_piloto', 'tipo_licenca_piloto','num_certificado_instrutor','validade_licenca_instrutor','num_licenca_instrutor','validade_certificado_piloto','num_certificado_piloto',
